...
export default function StartProgressPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0f1c] text-[#e8edf8]">
      ...
      <main className="mx-auto w-full max-w-3xl px-6 py-20 lg:px-8">
        <div className="mb-6">
          <Link href="/start/mode" className="inline-flex items-center gap-2 text-sm font-semibold text-white/70 hover:text-white">
        ...
        <div className="rounded-3xl border border-white/15 bg-white/5 p-8 text-center">
          ...
          <h1 className="mt-4 text-3xl font-semibold text-white">Setting up your resume workspace</h1>
